export const faq = [
  ...
  },
  {
    ...
    answer: "Notre processus se déroule en 4 étapes : 1) Discovery et analyse des besoins, 2) Conception et validation du design, 3) Développement et production, 4) Tests et livraison. Vous êtes impliqué à chaque étape pour garantir un résultat aligné avec vos attentes.",
  },
  {
  ...
  },
  {
    ...
    answer: "Nous utilisons les technologies les plus modernes et adaptées à chaque projet : React, Next.js, Node.js pour le développement web, React Native pour le mobile, et les derniers outils Adobe pour la production vidéo et le design.",
  },
];
